...
\caption{Pseudocode from Aine et al., detailing the original sequential version of the algorithm we parallelized.}
...
\begin{figure}
\centering
\includegraphics[width=1.6in]{graphs/hamstar}
\end{figure}
